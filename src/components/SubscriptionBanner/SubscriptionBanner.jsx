...
const SubscriptionBanner = () => {
    ...
    return (
        <div className={`subscription-banner ${tenant.shortName === "CF" || tenant.shortName === "Rett" || tenant.shortName === "RYR1" || tenant.shortName === "ALS" || tenant.shortName === "Asherman's" || tenant.shortName === "Aicardi" ? "background-alt" : ""}`}>
